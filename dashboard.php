...
<body>
  <header class="topbar">
    <div class="container">
      ...
      <nav>
        ...
        <a href="logout.php" class="btn small">Sair</a>
      </nav>
    </div>
  </header>
  ...
  <main class="container">
    <div class="card">
      ...
      <p><strong>Conta criada em:</strong> <?=htmlspecialchars($user['criado_em'])?></p>

      <hr>
      <h3>Área de teste</h3>
      <p>Aqui, futuramente, vais poder adicionar experiências, formações, habilidades e gerar o CV.</p>
      <p>Este protótipo cobre o fluxo de <strong>registro</strong> e <strong>login</strong>.</p>
    </div>
  </main>
</body>
</html>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav ms-auto register mb-2 mb-lg-0 flex-row align-items-center">
            <li class="nav-item me-2">
              <button class="btn btn-outline-primary"> <i class="bi bi-person-circle"></i> Entrar</button>
            </li>
            <li class="nav-item">
              <button class="btn btn-primary"> <i class="bi bi-box-arrow-in-right"></i> Cadastrar</button>
            </li>
          </ul>
        </div>
      </div>
  ...
  <div class="slide-content">
    ...
    <div class="slider-text">
      ...
      <div class="slider-buttons">
        <a href="#" class="btn btn-primary">Criar CV</a>
    ...
    <div class="slider-img">
      <img src="Midias/slides/cortesss.png" alt="CVLite Preview">
    </div>
  </div>
</section>
